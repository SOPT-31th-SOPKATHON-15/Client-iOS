...
public extension ObservableType {
    ...
    func throttleOnMain(_ dueTime: RxTimeInterval, latest: Bool = true) -> Observable<Element> {
        throttle(dueTime, latest: latest, scheduler: MainScheduler.instance)
    }
    
    func throttleOnBackground(_ dueTime: RxTimeInterval, latest: Bool = true) -> Observable<Element> {
